...
import com.example.station.model.exceptions.PasswordsDoNotMatchException;
...
public class RegisterController {
    ...
    public String register(@RequestParam String username,
        ...
        try{
            this.userService.register(embg, username, password, repeatedPassword, name, surname);
